...
// Remove ALL conditional rendering logic (HubSpot, Prerender, Normal)
/*
if (isHubSpotRequest) {
...
console.log('src/main.tsx loaded. Global styles imported. Vike handles app rendering and hydration.');
